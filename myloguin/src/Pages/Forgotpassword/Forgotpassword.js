  ...
  <div style={{ background: "linear-gradient(0deg, lightblue, #90caf9)" }}>
    <div style={{width:"100vw" , height:"100vh", display:'flex' , alignItems:"center" , justifyContent:"center"}}>
            <div style={{width:"25%" , padding:"20px" , margin:"auto" , borderRadius:"10px" , backgroundColor:"black"}}>
                <p style={{color:"black"}}>Enter your Email</p>
                <form style={{display:"flex" , flexDirection:"column"}}>
                    ...
                    <button style={{width:"40%" , border:"none" , padding:"10px 20px" , backgroundColor:"softblue" , color:"black" , borderRadius:"10px" , margin:"20px 0px" , cursor:"pointer"}} onClick={handleclick}>Enviar</button>
